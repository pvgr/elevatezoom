/*
 *  jQuery elevateZoom 4
 *
 *  Created by Andrew Eades, forked by PVgr from jQuery elevateZoom 3.0.8
 *
 *  Temporary demo's and documentation:
...
( function( $, window, document, undefined ) {
  var ElevateZoom = {
    init: function( options, elem ) {
      ...
      $( self.options.gallery ).first().children( 'a' ).on( 'click', function( e ) {
        // Set a class on the currently active gallery image
        if( self.options.galleryActiveClass ) {
          $( self.options.gallery ).first().children( 'a' ).removeClass( self.options.galleryActiveClass );
    ...
    startZoom: function() {
      ...
      if( self.options.zoomType == 'window' ) {
        ...
        self.lensStyle = 'background-position: 0 0;'
          ...
          + 'float: right; display: none; overflow: hidden; z-index: 200;'
      ...
      if ( isNaN( self.options.zoomWindowPosition ) ) {
        self.zoomWindow = $( '<div style="z-index: 200; left: ' + self.windowOffsetLeft + 'px; top:' + self.windowOffsetTop + 'px; ' + self.zoomWindowStyle + '" class="zoomWindow">&nbsp;</div>')
            .appendTo( 'body' )
            .click( function () {
              self.$elem.trigger( 'click' );
            } );
    ...
    swaptheimage: function( smallimage, largeimage ) {
      ...
      if ( self.options.loadingIcon ) {
        self.spinner = $('<div style="background: url("' + self.options.loadingIcon + '") no-repeat center; height: ' + self.nzHeight + 'px; width: ' + self.nzWidth + 'px; position: absolute; background-position: center center;"></div>');
    ...
    getGalleryList: function() {
      ...
      if ( self.options.gallery ) {
        $( self.options.gallery ).first().children( 'a' ).each( function() {
          var img_src = '';
